...
<html lang="en">
    <head>
        <!-- The styles -->
        <link  href="<?php echo base_url(); ?>/public/css/bootstrap-cerulean.min.css" rel="stylesheet" id="bs-css">
        ...
        <link href='<?php echo base_url(); ?>/public/bower_components/fullcalendar/dist/fullcalendar.print.css'
        ...
        <link href='<?php echo base_url(); ?>/public/bower_components/responsive-tables/responsive-tables.css'
        rel='stylesheet'>
        <link href='<?php echo base_url(); ?>/public/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css'
        rel='stylesheet'>
        ...
        <!-- jQuery -->
        <script src="<?php echo base_url(); ?>/public/bower_components/jquery/jquery.min.js">
        </script>
        <!-- The fav icon -->
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="navbar-inner">
                ...
                <a class="navbar-brand" href="#">
                    <img alt="Charisma Logo" src="<?php echo base_url(); ?>/public/img/logo20.png" class="hidden-xs" />
                    <span>
                        Mini_Ren
                    </span>
                </a>
